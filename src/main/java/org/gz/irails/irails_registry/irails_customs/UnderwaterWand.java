...
public class UnderwaterWand extends Item {
    ...
    static {
        ...
        BLOCK_MAP.put(IrailsBlocks.POWERED_TURNABLE_RAIL, IrailsBlocks.UNDERWATER_POWERED_TURNABLE_RAIL);
        BLOCK_MAP.put(IrailsBlocks.ALWAYS_POWERED_TURNABLE_RAIL, IrailsBlocks.UNDERWATER_ALWAYS_POWERED_TURNABLE_RAIL);
    }
