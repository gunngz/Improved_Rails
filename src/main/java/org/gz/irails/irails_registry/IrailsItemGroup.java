...
public class IrailsItemGroup {
    public static void registerRtsItemGroup() {
        ItemGroupEvents.modifyEntriesEvent(ItemGroups.REDSTONE).register(itemGroup -> {
            ...
            itemGroup.addAfter(IrailsItems.POWERED_RAIL_WITH_REDSTONE, IrailsItems.POWERED_TURNABLE_RAIL);
            itemGroup.addAfter(IrailsItems.POWERED_TURNABLE_RAIL, IrailsItems.ALWAYS_POWERED_TURNABLE_RAIL);
            ...
            itemGroup.addAfter(IrailsItems.UNDERWATER_ACTIVATOR_RAIL_WITH_DETECTOR, IrailsItems.UNDERWATER_POWERED_TURNABLE_RAIL);
            itemGroup.addAfter(IrailsItems.UNDERWATER_POWERED_TURNABLE_RAIL, IrailsItems.UNDERWATER_ALWAYS_POWERED_TURNABLE_RAIL);

            itemGroup.addAfter(IrailsItems.UNDERWATER_ALWAYS_POWERED_TURNABLE_RAIL, IrailsItems.LIGHT_POWERED_RAIL);
